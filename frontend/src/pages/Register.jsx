  ...
  return (
    <div className="flex-grow flex items-center justify-center p-6">
      <div className="glass-panel p-8 w-full max-w-md">
        <h2 className="text-2xl font-bold mb-6 text-center heading-gradient">Create Account</h2>
        ...
        <form onSubmit={onSubmit} className="flex flex-col gap-4">
          ...
          <input
            ...
            required
          />
          <button type="submit" className="glass-button w-full mt-2 py-3">Register</button>
        </form>
